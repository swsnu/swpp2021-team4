# Generated by Django 3.2.6 on 2021-11-02 15:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_image', models.ImageField(null=True, upload_to=route.models.Post.header_date_upload_to)),
                ('thumbnail_image', models.ImageField(null=True, upload_to=route.models.Post.thumbnail_date_upload_to)),
                ...
                ('season', models.ManyToManyField(blank=True, to='route.Season')),
                ('theme', models.ManyToManyField(blank=True, to='route.Theme')),
            ],
        ),
        migrations.CreateModel(
            name='Place',
