...
export const ADD_FOLDER_FAIL = 'user/add_folder_fail' as const;
export const ADD_FOLDER_SUCCESS = 'user/add_folder_success' as const;
...
export const DELETE_FOLDER_SUCCESS = 'user/delete_folder_success' as const;
export const DELETE_FOLDER_FAIL = 'user/delete_folder_fail' as const;
